# NOTE: This is the same as t/02_cud.t
# I just added it to check if renaming audit_log tables works
use strict;
use warnings;
...
my $schema = DBICx::TestDatabase->new('AuditTestRenamedTables::Schema');
